...
(cl:defmethod cl:initialize-instance :after ((m <Torque>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Torque)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exosystem-msg:<Torque> is deprecated: use exosystem-msg:Torque instead.")))

(cl:ensure-generic-function 'torque1-val :lambda-list '(m))
(cl:defmethod torque1-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exosystem-msg:torque1-val is deprecated.  Use exosystem-msg:torque1 instead.")
  (torque1 m))

(cl:ensure-generic-function 'torque2-val :lambda-list '(m))
(cl:defmethod torque2-val ((m <Torque>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exosystem-msg:torque2-val is deprecated.  Use exosystem-msg:torque2 instead.")
  (torque2 m))
