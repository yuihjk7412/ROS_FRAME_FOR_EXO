// Generated by gencpp from file shoulderexo/Sysstatus.msg
// DO NOT EDIT!


#ifndef SHOULDEREXO_MESSAGE_SYSSTATUS_H
#define SHOULDEREXO_MESSAGE_SYSSTATUS_H
...
struct Sysstatus_
{
  ...
  typedef boost::shared_ptr< ::shoulderexo::Sysstatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::shoulderexo::Sysstatus_<ContainerAllocator> const> ConstPtr;

}; // struct Sysstatus_

typedef ::shoulderexo::Sysstatus_<std::allocator<void> > Sysstatus;

typedef boost::shared_ptr< ::shoulderexo::Sysstatus > SysstatusPtr;
typedef boost::shared_ptr< ::shoulderexo::Sysstatus const> SysstatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::shoulderexo::Sysstatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::shoulderexo::Sysstatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct HasHeader< ::shoulderexo::Sysstatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::shoulderexo::Sysstatus_<ContainerAllocator> const>
  : FalseType
  { };
...
template <class ContainerAllocator>
struct IsFixedSize< ::shoulderexo::Sysstatus_<ContainerAllocator> const>
  : TrueType
  { };
...
template<class ContainerAllocator>
struct DataType< ::shoulderexo::Sysstatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::shoulderexo::Sysstatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::shoulderexo::Sysstatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::shoulderexo::Sysstatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::shoulderexo::Sysstatus_<ContainerAllocator>& v)
  {
...
#endif // SHOULDEREXO_MESSAGE_SYSSTATUS_H
